...
| [Debian](https://packages.debian.org/search?keywords=far2l) packages: | _none_ | `far2l` | `far2l` | `far2l-wx`<br><sub>(since _2.6.3~beta+ds-3_)</sub> |
| [Ubuntu](https://packages.ubuntu.com/search?keywords=far2l) packages: | _none_ | `far2l` | `far2l` | _none_ |
...
* **GUI** backend (Debian since far2l _2.6.3~beta+ds-3_)
    ```sh
